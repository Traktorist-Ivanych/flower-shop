...
namespace FlowerShop.Installers
{
    public class FlowerShopInstaller : MonoInstaller
    {
        ...
        [FormerlySerializedAs("flowerSaleTablesForCustomers")] [FormerlySerializedAs("flowerSaleTablesForByers")] [SerializeField] private FlowersSaleTablesForCustomers flowersSaleTablesForCustomers;
        ...
        [FormerlySerializedAs("upgradingAndRepairingHammer")] [SerializeField] private RepairingAndUpgradingHammer repairingAndUpgradingHammer;

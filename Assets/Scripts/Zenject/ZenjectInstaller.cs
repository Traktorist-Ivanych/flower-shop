...
public class ZenjectInstaller : MonoInstaller
{
    ...
    [SerializeField] private CurrentPlayerDinamicObject currentPlayerDinamicObject;
    ...
    public override void InstallBindings()
    {
        ...
        Container.Bind<CurrentPlayerDinamicObject>().FromInstance(currentPlayerDinamicObject).AsSingle().NonLazy();
